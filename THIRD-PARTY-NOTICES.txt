...
Package:Avalonia
Version:11.3.4
project URL:https://avaloniaui.net/?utm_source=nuget&utm_medium=referral&utm_content=project_homepage_link
...
Description:Avalonia is a cross-platform UI framework for .NET providing a flexible styling system and supporting a wide range of Operating Systems such as Windows, Linux, macOS and with experimental support for Android, iOS and WebAssembly.
licenseUrl:https://www.nuget.org/packages/Avalonia.Angle.Windows.Natives/2.1.25547.20250602/License
...
####################################################################################################
Package:HarfBuzzSharp.NativeAssets.Android
Version:8.3.1.1
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:HarfBuzzSharp is a cross-platform OpenType text shaping engine for .NET platforms.
licenseUrl:https://licenses.nuget.org/MIT
...
####################################################################################################
Package:HarfBuzzSharp.NativeAssets.iOS
Version:8.3.1.1
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:HarfBuzzSharp is a cross-platform OpenType text shaping engine for .NET platforms.
licenseUrl:https://licenses.nuget.org/MIT
...
####################################################################################################
Package:HarfBuzzSharp.NativeAssets.MacCatalyst
Version:8.3.1.1
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:HarfBuzzSharp is a cross-platform OpenType text shaping engine for .NET platforms.
licenseUrl:https://licenses.nuget.org/MIT
...
####################################################################################################
Package:HarfBuzzSharp.NativeAssets.Tizen
Version:8.3.1.1
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:HarfBuzzSharp is a cross-platform OpenType text shaping engine for .NET platforms.
licenseUrl:https://licenses.nuget.org/MIT
...
####################################################################################################
Package:HarfBuzzSharp.NativeAssets.tvOS
Version:8.3.1.1
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:HarfBuzzSharp is a cross-platform OpenType text shaping engine for .NET platforms.
licenseUrl:https://licenses.nuget.org/MIT
...
####################################################################################################
Package:SkiaSharp.NativeAssets.Android
Version:2.88.9
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:SkiaSharp is a cross-platform 2D graphics API for .NET platforms based on Google's Skia Graphics Library.
It provides a comprehensive 2D API that can be used across mobile, server and desktop models to render images.
...
####################################################################################################
Package:SkiaSharp.NativeAssets.iOS
Version:2.88.9
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:SkiaSharp is a cross-platform 2D graphics API for .NET platforms based on Google's Skia Graphics Library.
It provides a comprehensive 2D API that can be used across mobile, server and desktop models to render images.
...
####################################################################################################
Package:SkiaSharp.NativeAssets.MacCatalyst
Version:2.88.9
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:SkiaSharp is a cross-platform 2D graphics API for .NET platforms based on Google's Skia Graphics Library.
It provides a comprehensive 2D API that can be used across mobile, server and desktop models to render images.
...
####################################################################################################
Package:SkiaSharp.NativeAssets.Tizen
Version:2.88.9
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:SkiaSharp is a cross-platform 2D graphics API for .NET platforms based on Google's Skia Graphics Library.
It provides a comprehensive 2D API that can be used across mobile, server and desktop models to render images.
...
####################################################################################################
Package:SkiaSharp.NativeAssets.tvOS
Version:2.88.9
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:SkiaSharp is a cross-platform 2D graphics API for .NET platforms based on Google's Skia Graphics Library.
It provides a comprehensive 2D API that can be used across mobile, server and desktop models to render images.
...
####################################################################################################
Package:SkiaSharp.NativeAssets.UWP
Version:2.88.9
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:SkiaSharp is a cross-platform 2D graphics API for .NET platforms based on Google's Skia Graphics Library.
It provides a comprehensive 2D API that can be used across mobile, server and desktop models to render images.
...
####################################################################################################
Package:SkiaSharp.NativeAssets.watchOS
Version:2.88.9
project URL:https://go.microsoft.com/fwlink/?linkid=868515
Description:SkiaSharp is a cross-platform 2D graphics API for .NET platforms based on Google's Skia Graphics Library.
It provides a comprehensive 2D API that can be used across mobile, server and desktop models to render images.
...
####################################################################################################
Package:System.IO.UnmanagedMemoryStream
Version:4.3.0
project URL:https://dot.net/
